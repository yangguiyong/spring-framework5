...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	public void refresh() throws BeansException, IllegalStateException {
		synchronized (this.startupShutdownMonitor) {
			...
			try {
				...
				//当前版本该方法暂时没有任何实现，可能后面会做相应的实现
				postProcessBeanFactory(beanFactory);

				// Invoke factory processors registered as beans in the context.
				//1、扫描定义的类,生成BeanDefinition->放入beanDefinitionMap中，beanDefinitionMap是放在beanFacotry中的，就是初始化的时候DefaultListableBeanFactory中
				//2、执行自定义的BeanFactoryPostProcessor和Spring内置的BeanFactoryPostProcessor
	...
	public Object getBean(String name) throws BeansException {
		...
		//getBeanFactory获取DefaultListableBeanFactory的实例
